HTML creare elemento in  cui inserire i numeri da memorizzare, generati randomicamente su js (range da a scelta). inizialmente saranno inseriti in forma grezza senza customizazzioni particolari.
